...
export const BRAND = {
  ...
  description: {
    en: 'Plan the day and the long haul on one screen, work through it, and watch the hours turn into progress — tasks, reminders, documents and focus in one place.',
    bg: 'Планираш деня и дългия път на един екран, вършиш ги и гледаш как часовете стават резултат — задачи, напомняния, документи и фокус на едно място.',
  },

  /** Shorter, for metadata where length is punished. */
  meta: {
    en: 'Plan, do, focus and track — Plauvia holds your day, your reminders, your documents and your flashcards in one place, and works offline.',
    bg: 'Планирай, върши, фокусирай се и следи напредъка — Plauvia държи деня, напомнянията, документите и картите на едно място и работи офлайн.',
  },
} as const;
